Citizen.CreateThread(function()
    ...
    while true do
        ...
        RemoveVehiclesFromGeneratorsInArea(316.79 - 300.0, -592.36 - 300.0, 43.28 - 300.0, 316.79 + 300.0, -592.36 + 300.0, 43.28 + 300.0) -- Pillbox Hill
        ...
        RemoveVehiclesFromGeneratorsInArea(-1108.35 - 300.0, 4920.64 - 300.0, 217.2 - 300.0, -1108.35 + 300.0, 4920.64 + 300.0, 217.2 + 300.0) -- Nudist Village
        ...
        RemoveVehiclesFromGeneratorsInArea(-1528.5920, 84.3852, 56.6385, 197.0927 - 300.0, -724.46 + 300.0, -1444.03 + 300.0, 5.0 + 300.0) -- PlayBoy Mansion v2 UncleJust
        Wait(2000)
    end
end)